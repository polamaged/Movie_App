...
class ForthBoarding extends StatelessWidget {
  const ForthBoarding({super.key});
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        SizedBox.expand(
          child: Image.asset(Assets.imagesDoctorstrange, fit: BoxFit.fill),
        ),
        Container(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: CustomButtom(
                    onPressed: () {
                      Navigator.pushNamed(context, RouteManager.lastBoarding);
                    },
                    text: "Next",
